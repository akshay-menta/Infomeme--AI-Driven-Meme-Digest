...
Max_length = 256
Seed = 42
Output_dir = "./liar2-bert-finetuned"
Device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# Loading LIAR2 dataset and adding combined text field for BERT.
...
# Tokenizing the combined text field and preparing for PyTorch.
...
# Training model with early stopping and return Trainer instance.
...
# Evaluating trained model on test set and save reports.
...
# Predicting the label and confidence score for a given statement.
